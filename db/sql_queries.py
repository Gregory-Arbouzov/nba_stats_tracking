...
get_all_yearly_team_stats_data = """SELECT * FROM yearly_team_per_game_stats;"""

get_all_yearly_opponent_stats_data = """SELECT * FROM yearly_opponent_per_game_stats;"""

get_all_game_results_data = """SELECT * FROM game_results;"""