...
nba_teams_by_season = {
    ...
    2008: ['PHO', 'DAL', 'LAL', 'SAS', 'MIN', 'UTA', 'POR', 'SEA', 'SAC', 'LAC', 'GSW', 'DEN', 'MEM', 'CHI', 'IND', 'MIL', 'CLE', 'TOR', 'NYK', 'BOS', 'DET', 'MIA', 'WAS', 'ORL', 'ATL', 'CHA'],
    2009: ['PHO', 'DAL', 'LAL', 'SAS', 'MIN', 'UTA', 'POR', 'SAC', 'LAC', 'GSW', 'DEN', 'MEM', 'CHI', 'IND', 'MIL', 'CLE', 'TOR', 'NYK', 'BOS', 'DET', 'MIA', 'WAS', 'ORL', 'ATL', 'CHA', 'OKC'],  # OKC (formerly SEA)
    2010: ['PHO', 'DAL', 'LAL', 'SAS', 'MIN', 'UTA', 'POR', 'SAC', 'LAC', 'GSW', 'DEN', 'MEM', 'CHI', 'IND', 'MIL', 'CLE', 'TOR', 'NYK', 'BOS', 'DET', 'MIA', 'WAS', 'ORL', 'ATL', 'CHA', 'OKC'],
    2011: ['PHO', 'DAL', 'LAL', 'SAS', 'MIN', 'UTA', 'POR', 'SAC', 'LAC', 'GSW', 'DEN', 'MEM', 'CHI', 'IND', 'MIL', 'CLE', 'TOR', 'NYK', 'BOS', 'DET', 'MIA', 'WAS', 'ORL', 'ATL', 'CHA', 'OKC'],
...
for year in nba_teams_by_season.keys():
    for team in nba_teams_by_season[year]:
        valid_seasons.append(team + str(year))